...
function wanted($fName, $specs, $mugs, $sR, $awardfCap){
    ...
    echo $awardfCap = (10 * ($specs * $specs * $mugs * $mugs * $sR * $sR)/2);
}
...
//function to set the minimum height
...
what if you had not 3 cars, but 300? The solution is to create an array! An array
can hold many values under a single name, and you can access the values by referring to an index number.
